...
const styles = {
  root: { padding: 20, display: 'flex', gap: '20px' },
...
export default function App() {
  const { gameState, log, selectedPiece, gameId, handleSelect, handleSelectFromHand, endTurn } = useGame();
  ...
  return (
    <div style={styles.root}>
      <div style={styles.gameArea}>
        <h2>Stasis Chess</h2>
        <p>Game ID: {gameId}</p>
        <Board pieces={gameState.pieces} onSelect={handleSelect} />
